...
DataTableFromFile<-read.table("TempFiles/SNPMatrix_GoodLocations.txt", header=TRUE, sep = "\t")  
...
write.table(SNPMatrixWithLociWithMinGenotypes, file = "Output/Genotypes/SNPMatrixTemp_100B.txt", sep = "	",row.names=FALSE, col.names=FALSE)  
########################################################################################################################################################

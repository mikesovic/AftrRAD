DataTableFromFile<-read.table("TempFiles/Genotypes.txt", header=TRUE, sep = "\t")
...
write.table(SNPMatrix, file = "TempFiles/SNPMatrixAll.txt", sep = "\t",row.names=FALSE, col.names=FALSE)       

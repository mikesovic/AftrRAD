...
print "Before running this script, make sure that you have edited the file \"Genotypes/Output/SNPMatrix_X.Y.txt\" so that the first sample in the file is an outgroup individual, and the remaining ingroup samples are grouped by population.\n\n";

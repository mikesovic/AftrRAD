...
DataTableFromFile<-read.table("TempFiles/GenotypesUpdate.txt", header=TRUE, sep = "\t")  
...
write.table(SNPLocationsMatrix,file="TempFiles/SNPLocations.txt",row.names=FALSE, col.names=FALSE)
write.table(SNPMatrix,file="TempFiles/TempSNPMatrix.txt",row.names=FALSE, col.names=FALSE, sep="\t")